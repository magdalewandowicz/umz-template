...
rdev = pd.read_csv('dev-0/in.tsv', sep='\t', names=["A1", "A2", "B1", "B2", "C1", "C2","D1", "D2", "E1", "E2", "F1", "F2","G1", "G2", "H1", "H2", "I1", "I2","J1", "J2", "K1", "K2", "L1", "L2","M1", "M2", "N1", "N2", "O1", "O2","P1", "P2", "Q1", "Q2","R1", "R2"])
rdev = pd.DataFrame(rdev,columns = ["B1"])
rdev2 = pd.read_csv('test-A/in.tsv', sep='\t', names=["A1", "A2", "B1", "B2", "C1", "C2","D1", "D2", "E1", "E2", "F1", "F2","G1", "G2", "H1", "H2", "I1", "I2","J1", "J2", "K1", "K2", "L1", "L2","M1", "M2", "N1", "N2", "O1", "O2","P1", "P2", "Q1", "Q2","R1", "R2"])
rdev2 = pd.DataFrame(rdev2,columns = ["B1"])
