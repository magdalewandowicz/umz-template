...
scaler.fit(X_train)
X_train2 = pd.DataFrame(scaler.transform(X_train), columns=["isNew", "rooms", "floor", "sqrMetres"])
...
def create_baseline():
    ...
    # model.add(Dense(1, input_dim=X_train2.shape[1], activation='relu', kernel_initializer='normal'))
